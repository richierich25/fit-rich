...
```sh
$ git clone https://github.com/<your-name>/fit-rich
$ cd weather-bot
$ npm install
```
...
If you would like to contribute to the project for the first time, please consider joining checking the [bug](https://github.com/richierich25/fit-rich/issues?q=is%3Aissue+is%3Aopen+label%3A%22%F0%9F%90%9B+bug%22) or [good first issue](https://github.com/richierich25/fit-rich/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) labels.
